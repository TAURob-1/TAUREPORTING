/**
 * Audience Graph — Baseline Score Library
 *
 ...
 * ATTRIBUTE_CLASSES
 *
 * Each class has a key, label, color, and a map of attributes.
 * Each attribute has: label, and scores: { M_XXX: { P, S } }
 *
 * Class-level defaults are merged so only deviations need explicit values.
 */
...
/**
 * EXAMPLE_AUDIENCES — Pre-built templates
 */
...
/**
 * Tactical recommendation templates per mechanism
 */
const MECHANISM_RECOMMENDATIONS = {
  M_GEO: {
