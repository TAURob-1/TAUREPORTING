/**
 * Keyword Clusters — M-KEY Drill-Down Data
 *
...
/**
 * Fallback generic keyword clusters for classes without specific data
 * (DEMO, SOCIO, GEO, MEDIA)
 */
const KEYWORD_CLASS_DEFAULTS = {
  DEMO: [
